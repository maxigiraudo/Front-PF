      ...
      <section className={style.footerinfo}>
        ...
        <section className={style.footerinfocenter}>
          ...
          <ul className={style.hola}>
            ...
            <li><a className={style.enlace} href='https://www.linkedin.com/in/jonathan-andres-caliva-891328172/'>Soledad Olmos</a></li>
          ...
          <ul className={style.chau}>
            ...
            <li><a className={style.enlace} href='https://www.linkedin.com/in/jonathan-andres-caliva-891328172/'>Florencia </a></li>
